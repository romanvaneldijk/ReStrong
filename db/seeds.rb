...
10.times do
  ...
  file = URI.open(dish_images.sample)
  # tent.photo.attach(io: file, filename: "tent", content_type: 'image/jpg')
  tent.save
  puts 'creating dish'
end
